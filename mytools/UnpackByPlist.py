...
"""
图片集切割工具
支持plist，大图格式为png格式的图片集
把图片集放到filename下，plist文件和大图一起放
by anwin  2019-02-22
"""
...
def packdirHandle(rootdir):
    ...
    for file_name in file_name_set:
        plist_filename = os.path.join(rootdir, file_name) + '.plist'
...
if __name__ == '__main__':
    # filename = sys.argv[1]
    # filename = "/Users/anwin/Desktop/test"
    filename = raw_input("请输入图片集目录:")
    packdirHandle(filename)
